    ...
    <section class="container quiz_container">
        ...
        <form action="score.php" method="post">
            ...
            <div id="box_5" class="box">
                ...
                <div class="RadioButton">
                    <label>
                        <input type="checkbox" name="medical_condition5"> <span class="radioP">privately-owned
                            e-scooters
                            and
                    ...
                    <br>
                    <label>
                        <input type="checkbox" name="medical_condition5"> <span class="radioP">Sfoldable e-bikes are NOT
                            covered
                            by this notice</span>
                    </label>
                    <br>
                    ...
                    <label>
                        <input type="checkbox" name="medical_condition5"> <span class="radioP">privately-owned
                            e-scooters
                            and
                            e-unicycles are NOT allowed on any TfL services</span>
                    </label>
                    <br>
                    <label>
                        <input type="checkbox" name="medical_condition5"> <span class="radioP">According to Section 165
                            of
                            the
            ...
            <div id="box_7" class="box">
                ...
                <div class="tables_ui" id="t_draggable2">
            ...
            <div id="box_10" class="box">
                ...
                <div class="row RadioButton">
                    ...
                    <div class="col-md-4 center">
                        <button id="11" type="submit" type="button" class="button-next btn_next">Submit <span
